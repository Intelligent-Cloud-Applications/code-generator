  ...
  return (
    <>
      ...
      <div className={`flex flex-col gap-16 py-10 items-center Background`}>
        ...
        <div className={`mb-10`}>
          <div
            className={`bg-white flex pr-[2rem] pl-[2rem] shadow-2xl gap-8`}
          >
            <div
              className={`mt-[2rem] mb-[2rem] p-10 max850:hidden w-[18rem] flex flex-col gap-[1rem]`}
              style={{
            ...
            <div className={`sans-sarif flex flex-col items-center gap-10 py-4`}>
              <h3 className=" font-bold">FILL IT UP!</h3>
