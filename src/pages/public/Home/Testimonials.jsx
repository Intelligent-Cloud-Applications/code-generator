...
const Testimonial = () => {
  ...
  const [selectedTestimonialIndex, setSelectedTestimonialIndex] =
    useState(null); // Track selected testimonial
  ...
  const centralizeApiCall = async (action, testimonialData) => {
    try {
      ...
      if (action === "add") {
        ...
        updatedTestimonials = testimonials.filter(
          (_, index) => index !== selectedTestimonialIndex
        );
      }
  ...
  const handleUpdateTestimonial = async () => {
    try {
      ...
      const updatedTestimonial = {
        ...
        description:
          updateFeedback || testimonials[selectedTestimonialIndex].description,
  ...
  return (
    <div id="testimonial-section" className="font-sans">
      <div
        className={`flex flex-col item-center bg-black h-full`}
        style={{
      ...
      >
        <div className="py-16 flex flex-col">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold uppercase tracking-wider text-white mb-12 items-center text-center" 
