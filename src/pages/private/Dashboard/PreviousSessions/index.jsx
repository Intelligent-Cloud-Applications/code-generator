              ...
              {!attendanceList ? (
                ...
                >
                  <div className={`flex w-[85%] justify-between  mb-3 font-bold`}>
                    ...
                    <p className={`w-[20%] text-left overflow-hidden ml-[-4rem]`}>
                      Class
                    </p>
                    <p className={`overflow-hidden w-[3.7rem] ml-[-1rem] `}>Date</p>
                    <p className={UserCtx.userData.userType === 'member' ? "w-[7.3rem] mr-0" : `w-[7.3rem] mr-[3.5rem]`}>Recording Link</p>
                  </div>
                </li>
              ) : (
                <div className="flex w-full ml-[-2rem] mb-3 mt-[-1rem] justify-between border-b-2 items-center h-[4rem]"
                  style={{
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <div className={!(UserCtx.userData.userType === 'member') ? "flex gap-5" : ""}>
                                <div
