const customTheme = {
    ...
    field: {
      ...
      input: {
        ...
        colors: {
          ...
          primary:
            "border-primaryColor focus:border-primaryColor focus:ring-primaryColor dark:border-primaryColor dark:placeholder-primaryColor dark:focus:border-primaryColor dark:focus:ring-primaryColor",
        },
        withRightIcon: {
          on: "pr-10",
          off: "",
  ...
  table: {
    ...
    "body": {
      "base": "group/body",
      "cell": {
        "base": "bg-lighestPrimaryColor text-white bg-opacity-30 px-6 py-4 group-first/body:group-first/row:first:rounded-tl-lg group-first/body:group-first/row:last:rounded-tr-lg group-last/body:group-last/row:first:rounded-bl-lg group-last/body:group-last/row:last:rounded-br-lg "
      }
    },
    "head": {
